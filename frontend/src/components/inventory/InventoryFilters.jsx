...
import { ITEM_TYPES } from '../../services/inventory.service'
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        <Select label="Item type" value={filters.item_type} onChange={event => update('item_type', event.target.value)} options={[{ value: '', label: 'All item types' }, ...ITEM_TYPES]} />
